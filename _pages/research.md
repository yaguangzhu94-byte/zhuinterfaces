...
<div class="zhu-research-page">
  ...
  <section class="research-direction research-direction-one" id="interfaces">
    <div class="direction-copy direction-one-copy">
      ...
      <h2>Watching working interfaces reorganize during electrochemical transformations.</h2>
      <p>Electrochemical reactions take place inside dynamic, multiphase environments where catalysts, electrolytes, dissolved species, gases, and solid products continuously reorganize. We use carbon dioxide electroreduction and ammonia oxidation as representative reactions to determine how these evolving interfaces regulate reaction pathways, mass transport, selectivity, and stability.</p>
      <p>To directly connect local structure with device behavior, we combine purpose-built electrochemical cells with <em>operando</em> synchrotron radiography and diffraction. Radiography reveals gas and liquid redistribution in real time, while diffraction identifies structural and phase evolution inside the working device. Together, these measurements allow us to resolve processes that are difficult to infer from electrochemical performance alone.</p>
    </div>
